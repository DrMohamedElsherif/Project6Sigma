...
class Probabilityplot5Config(BaseModel):
    title: str


class Probabilityplot5Data(BaseModel):
    values: Dict[str, List[float]] = Field(..., min_length=1)


class Probabilityplot5Request(BaseModel):
    project: str
    step: str
    config: Probabilityplot5Config
    data: Probabilityplot5Data


class Probabilityplot5:
    def __init__(self, data: dict):
        try:
            validated_data = Probabilityplot5Request(**data)
    ...
    def process(self):
        ...
        self.figure, axes = plt.subplots(num_rows, num_columns,
                                         figsize=(15, 6.5 * num_rows))
