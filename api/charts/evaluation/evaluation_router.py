...
# Boxplot endpoints
@router.post("/boxplot1")
async def generate_boxplot1(request: dict):
    from .boxplot1 import Boxplot1
    return await generate_chart(request, Boxplot1, "error_processing")


@router.post("/boxplot2")
async def generate_boxplot2(request: dict):
    from .boxplot2 import Boxplot2
    return await generate_chart(request, Boxplot2, "error_processing")


@router.post("/boxplot3")
async def generate_boxplot3(request: dict):
    from .boxplot3 import Boxplot3
    return await generate_chart(request, Boxplot3, "error_processing")


@router.post("/boxplot4")
async def generate_boxplot4(request: dict):
    from .boxplot4 import Boxplot4
    return await generate_chart(request, Boxplot4, "error_processing")


@router.post("/boxplot5")
async def generate_boxplot5(request: dict):
    from .boxplot5 import Boxplot5
    return await generate_chart(request, Boxplot5, "error_processing")


@router.post("/boxplot6")
async def generate_boxplot6(request: dict):
    from .boxplot6 import Boxplot6
    return await generate_chart(request, Boxplot6, "error_processing")
