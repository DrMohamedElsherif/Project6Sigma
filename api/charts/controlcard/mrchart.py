...
class Mrchart:
    ...
    def process(self):
        ...
        ax2.axhline(mr_ucl, color='#a03130', linestyle='dashed', label=f'UCL={round(mr_ucl, 3)}')
        ax2.axhline(mr_mean, color='grey', label=f'MR={round(mr_mean, 3)}', linestyle='dashed', alpha=0.7)
        ax2.axhline(mr_lcl, color='#a03130', linestyle='dashed', label=f'LCL={round(mr_lcl, 3)}')
